...
This is my =.emacs.el= file, as an =emacs.org= file.

- Browse it online [[http://lumiere.ens.fr/~guerry/emacs.html][here]].
- Browse the =.el= file [[http://lumiere.ens.fr/~guerry/u/emacs.el][here]].
- Clone the =.org= and file from [[https://github.com/bzg/dotemacs][github]].

Comments are welcome: =bzg AT gnu DOT org=
