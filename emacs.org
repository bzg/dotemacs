...
;; I find this useful to have a local search ring:
...
(add-hook 'emacs-lisp-mode-hook 'electric-pair-mode 'append 'local)
(add-hook 'emacs-lisp-mode-hook 'electric-indent-mode 'append 'local)
