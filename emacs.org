...
(setq org-todo-keyword-faces '(("STRT" . "DarkOrange")
                               ("WAIT" . "Black")
                               ("CANCELED" . "DarkGray")))
...
(define-key gnus-group-mode-map "X"
  (lambda (maybe-close)
    (interactive "P")
    (if maybe-close
        (progn (gnus-server-offline-server "nnimap:imap.cnam.fr")
               (gnus-server-offline-server "nntp:news")
               (gnus-server-offline-server "nntp:free"))
