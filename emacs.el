...
(setq org-capture-templates
	...
	("O" "Org" entry (file+headline "~/org/bzg.org" "Buffer") ;; Org-mode/Buffer
	 "* TODO %a\n  :PROPERTIES:\n  :CAPTURED: %U\n  :END:\n\n" :prepend t)
...
(setq org-agenda-custom-commands
	...
	("n" . "What's next?")
	("nn" "Main (all)" tags-todo "TODO={STRT\\|NEXT}"
	 ((org-agenda-files '("~/org/bzg.org"))
	  (org-agenda-sorting-strategy
	   '(todo-state-up  priority-down time-up))))
	("n!" "Etalab" tags-todo "TODO={STRT\\|NEXT}"
	...
	("n?" "Main (no work)" tags-todo "TODO={STRT\\|NEXT}"
	 ((org-agenda-category-filter-preset '("-ETL"))
	  ...
	  (org-agenda-sorting-strategy
	   '(todo-state-up  priority-down time-up))))
	("n/" "Libre" tags-todo "TODO={STRT\\|NEXT}"
	...
	("d!" "Etalab deadlines" agenda "Past/upcoming work deadlines"
	 ((org-agenda-span 1)
	  (org-agenda-category-filter-preset '("+ETL"))
	  (org-deadline-warning-days 100)
	  (org-agenda-entry-types '(:deadline))
	...
	("v" . "View")
	("vv" "Main" tags-todo "+View+TODO={NEXT\\|STRT}")
	...
	("l" . "Listen")
	("ll" "Main" tags-todo "+Listen+TODO={NEXT\\|STRT}")
	...
	("c" . "Code")
	("cc" "Main" tags-todo "+Code+TODO={NEXT\\|STRT}")
