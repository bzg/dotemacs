...
(global-set-key (kbd "C-é") (lambda () (interactive) (bzg-big-fringe-mode -1) (delete-other-windows) (split-window-right) (other-window 1) (balance-windows)))
...
(setq org-agenda-custom-commands
	...
	("V" tags-todo "+View+TODO={NEXT\\|STRT}"
	 ((org-agenda-files '("~/org/libre.org"))))
	("l" tags-todo "+Listen+TODO={NEXT\\|STRT}")
	("L" tags-todo "+Listen+TODO={NEXT\\|STRT}"
	 ((org-agenda-files '("~/org/libre.org"))))
